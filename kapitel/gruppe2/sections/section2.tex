...
\begin{figure}[h]
	\centering
	\fbox{ \includegraphics[width=14cm]{kapitel/gruppe2/bilder/farbcode_spss}}
...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=14cm]{kapitel/gruppe2/bilder/sortierung_fragentyp}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=15cm]{kapitel/gruppe2/bilder/auszug_leitfaden}
...
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[width=15cm]{kapitel/gruppe2/bilder/E-Learning_Transkription}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=15cm]{kapitel/gruppe2/bilder/E-Learning_MM}
