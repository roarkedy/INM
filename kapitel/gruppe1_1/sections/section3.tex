...
Bei der Einführung eines Informationsmanagements zählen die vorausschauende Planung, welche Hard- und Software-Ressourcen von Nöten sind und die gezielte Implementierung dieser im Unternehmen zu den grundlegenden Aufgaben. Weiterhin wird die Qualität der zu vermittelnden Informationen und im Folgekapitel \ref{section_qualitaetsmanagement_der_informationsprozesse} auch der Kommunikationswege von Informationssender zu -empfänger genauer beleuchtet, um Ansatzpunkte zu liefern, in welchen unternehmensspezifischen Prozessen Handlungsbedarf bestehen könnte. 
