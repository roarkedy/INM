...
Im Folgenden soll das Informationsmanagement im Allgemeinen erklärt werden; auf die Besonderheiten von Hochschulen wird in dem Abschnitt \ref{grundlegende_aufgaben_des_informationsmanagements} (Grundlegende Aufgaben des Informationsmanagements) genauer eingegangen.
