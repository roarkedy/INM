...
\begin{table}[h!]
	\begin{tabularx}{\textwidth}{|X|X|X|}
		...
		\hline
	\end{tabularx}
	\caption{Typen von Changes}\footnotetext{\cite[48]{breiter_implementierung_2011}}
	\label{tab_typen_von_changes}
\end{table}

\todo[inline]{AW: Quellenangabe für die Tabelle wird nicht ausgegeben}
...
\todo[inline]{AW: Positionierung der Grafik Prozessoptimierung unter gleichnamigem Kapitel}
